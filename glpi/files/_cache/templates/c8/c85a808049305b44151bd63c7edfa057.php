...
class __TwigTemplate_0787e45324d4753b797cdcffba522246 extends Template
{
    private $source;
    private $macros = [];
...
($context["rand"] ?? null)]], 342, $context, $this->getSourceContext());
            ...
            if ($this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("PendingReason_Item::canDisplayPendingReasonForItem", [($context["subitem"] ?? null)])) {
                ...
                echo "\"
                                 ...
                                 ";
                // line 412
                echo ((((($__internal_compile_46 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 412)) && is_array($__internal_compile_46) || $__internal_compile_46 instanceof ArrayAccess ? ($__internal_compile_46["status"] ?? null) : null) == twig_constant("CommonITILObject::WAITING"))) ? ("checked") : (""));
                echo "
            ...
            echo "            <div class=\"d-flex card-footer mx-n3 mb-n3 flex-wrap\" style=\"row-gap: 10px; min-height: 79px\">
               ";
            // line 433
            if (((($__internal_compile_47 = twig_get_attribute($this->env, $this->source, ($context["subitem"] ?? null), "fields", [], "any", false, false, false, 433)) && is_array($__internal_compile_47) || $__internal_compile_47 instanceof ArrayAccess ? ($__internal_compile_47["id"] ?? null) : null) <= 0)) {
                // line 434
                echo "                  ";
                // line 435
               ...
               ";
                ...
                echo twig_escape_filter($this->env, (($__internal_compile_48 = twig_get_attribute($this->env, $this->source, ($context["subitem"] ?? null), "fields", [], "any", false, false, false, 443)) && is_array($__internal_compile_48) || $__internal_compile_48 instanceof ArrayAccess ? ($__internal_compile_48["id"] ?? null) : null), "html", null, true);
                echo "\" />
                ...
                echo "</span>
                  ...
                  ";
                // line 449
                if (twig_get_attribute($this->env, $this->source, ($context["subitem"] ?? null), "can", [(($__internal_compile_49 = twig_get_attribute($this->env, $this->source, ($context["subitem"] ?? null), "fields", [], "any", false, false, false, 449)) && is_array($__internal_compile_49) || $__internal_compile_49 instanceof ArrayAccess ? ($__internal_compile_49["id"] ?? null) : null), twig_constant("PURGE")], "method", false, false, false, 449)) {
                    // line 450
         ...
         function itiltasktemplate_update";
            ...
            echo "',
               ...
               data: {
                  ...
                  items_id: '";
            // line 471
            echo twig_escape_filter($this->env, (($__internal_compile_50 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 471)) && is_array($__internal_compile_50) || $__internal_compile_50 instanceof ArrayAccess ? ($__internal_compile_50["id"] ?? null) : null), "html", null, true);
            echo "',
                  itemtype: '";
            // line 472
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getType", [], "method", false, false, false, 472), "html", null, true);
            echo "'
               }
            }).done(function (data) {
