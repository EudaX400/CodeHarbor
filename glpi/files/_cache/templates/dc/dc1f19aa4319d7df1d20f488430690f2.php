...
class __TwigTemplate_83e3e526fc7d40b26deb3a68b279b6e1 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (( !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 38) && $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call((twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getType", [], "method", false, false, false, 38) . "::isMassiveActionAllowed"), [(($__internal_compile_0 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 38)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["id"] ?? null) : null)]))) {
            ...
            // line 40
            echo "   ";
            if ((twig_length_filter($this->env, (($__internal_compile_1 = ($context["input"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["actions"] ?? null) : null)) > 0)) {
                // line 41
                echo "   ";
   ...
   <div id=\"single-ma-action-menu\" class=\"dropdown-menu dropdown-menu-end dropdown-menu-arrow mt-2\" aria-labelledby=\"single-action\">
      ";
                ...
                $context['_seq'] = twig_ensure_traversable((($__internal_compile_2 = ($context["input"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["actions"] ?? null) : null));
