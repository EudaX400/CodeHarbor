...
class __TwigTemplate_42d031da20a2a0d47a78079524435d14 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 39
        $context["user_thumbnail"] = twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "getThumbnailPicturePath", [($context["enable_anonymization"] ?? null)], "method", false, false, false, 39);
        // line 40
        if (((($context["user_thumbnail"] ?? null) == null) &&  !$this->extensions['Glpi\Application\View\Extension\ConfigExtension']->getEntityConfig("display_users_initials", $this->extensions['Glpi\Application\View\Extension\SessionExtension']->session("glpiactive_entity")))) {
            // line 41
            echo "    ";
            $context["user_thumbnail"] = twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "getPicturePath", [($context["enable_anonymization"] ?? null)], "method", false, false, false, 41);
        }
        // line 43
        echo "
";
...
<span class=\"avatar ";
   ...
   ";
        ...
        if ((null === ($context["user_thumbnail"] ?? null))) {
            // line 51
            echo "         ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "getUserInitials", [($context["enable_anonymization"] ?? null)], "method", false, false, false, 51), "html", null, true);
            echo "
   ";
        }
        // line 53
...
";
    ...
    {
        return new Source("", "components/user/picture.html.twig", "/var/www/html/glpi/templates/components/user/picture.html.twig");
    }
}
