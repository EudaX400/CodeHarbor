...
class __TwigTemplate_a2292a00d5dba9251b377de422b7eb3c extends Template
{
    private $source;
    private $macros = [];
   ...
   ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 52)) {
                ...
                if (($context["can_create"] ?? null)) {
                    ...
                    // line 55
                    echo "         ";
                    if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["field_options"] ?? null), "fields_template", [], "any", false, false, false, 55), "isMandatoryField", ["_add_validation"], "method", false, false, false, 55)) {
                        // line 56
                        echo "            ";
...
($context["validation"] ?? null), "dropdownValidator", [twig_array_merge(["name" => "users_id_validate", "entity" => (($__internal_compile_2 = twig_get_attribute($this->env, $this->source,                     // line 65
...
($context["field_options"] ?? null)], 61, $context, $this->getSourceContext());
      ...
      ";
                ...
                // line 78
                echo "        ";
                if ( !twig_get_attribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "isHiddenField", ["global_validation"], "method", false, false, false, 78)) {
                    // line 79
                    echo "            ";
                    echo twig_call_macro($macros["fields"], "macro_htmlField", ["global_validation", $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("TicketValidation::getStatus", [(($__internal_compile_5 = twig_get_attribute($this->env, $this->source,                     // line 81
