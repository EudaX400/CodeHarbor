...
class __TwigTemplate_22d134d9a3980bc29717d239cae4cd76 extends Template
{
    private $source;
    private $macros = [];
...
($context["canupdate"] ?? null) || ($context["can_requester"] ?? null))]);
        // line 40
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["field_options"] ?? null), "fields_template", [], "any", false, false, false, 40), "isMandatoryField", ["urgency"], "method", false, false, false, 40)) {
            // line 41
            echo "   ";
...
($context["item"] ?? null), "dropdownUrgency", [twig_array_merge(["value" => (($__internal_compile_0 = twig_get_attribute($this->env, $this->source,         // line 49
...
";
        ...
        // line 59
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["field_options"] ?? null), "fields_template", [], "any", false, false, false, 59), "isMandatoryField", ["impact"], "method", false, false, false, 59)) {
            // line 60
            echo "   ";
...
($context["item"] ?? null), "dropdownImpact", [twig_array_merge(["value" => (($__internal_compile_1 = twig_get_attribute($this->env, $this->source,         // line 68
...
($context["canpriority"] ?? null), "withmajor" => true]);
        // line 81
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["field_options"] ?? null), "fields_template", [], "any", false, false, false, 81), "isMandatoryField", ["priority"], "method", false, false, false, 81)) {
            // line 82
            echo "   ";
...
($context["item"] ?? null), "dropdownPriority", [twig_array_merge(["value" => (($__internal_compile_2 = twig_get_attribute($this->env, $this->source,         // line 90
...
\$(function() {
   \$('#dropdown_urgency";
      ...
      \$.ajax({
        ...
        // line 106
        echo twig_escape_filter($this->env, ($context["rand"] ?? null), "html", null, true);
        echo "').select2('data') ? \$('#dropdown_urgency";
        echo twig_escape_filter($this->env, ($context["rand"] ?? null), "html", null, true);
        echo "').select2('data')[0].id : 0,
            'impact':  \$('#dropdown_impact";
        // line 107
        echo twig_escape_filter($this->env, ($context["rand"] ?? null), "html", null, true);
        echo "').select2('data') ? \$('#dropdown_impact";
        echo twig_escape_filter($this->env, ($context["rand"] ?? null), "html", null, true);
        echo "').select2('data')[0].id : 0,
