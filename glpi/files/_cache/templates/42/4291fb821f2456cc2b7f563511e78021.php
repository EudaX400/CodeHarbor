...
class __TwigTemplate_3841011c9977a847481809e9ae427ad3 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ((($context["canedit"] ?? null) || twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "canEdit", [(($__internal_compile_8 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 43)) && is_array($__internal_compile_8) || $__internal_compile_8 instanceof ArrayAccess ? ($__internal_compile_8["id"] ?? null) : null)], "method", false, false, false, 43))) {
         ...
         ";
            ...
            ";
                ...
                // line 58
                echo "            ";
                if (((($context["candel"] ?? null) &&  !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "can", [($context["id"] ?? null), twig_constant("DELETE")], "method", false, false, false, 58)) &&  !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "can", [($context["id"] ?? null), twig_constant("PURGE")], "method", false, false, false, 58))) {
                    // line 59
                    echo "               ";
            ...
            ";
                // line 62
                if ((($context["canedit"] ?? null) && twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "can", [($context["id"] ?? null), twig_constant("UPDATE")], "method", false, false, false, 62))) {
                    // line 63
                    echo "               <button class=\"btn btn-primary me-2\" type=\"submit\" name=\"update\" value=\"1\">
                  <i class=\"far fa-save\"></i>
                  <span>";
            ...
            ";
                ...
                if (($context["candel"] ?? null)) {
                    ...
                    if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isDeleted", [], "method", false, false, false, 70)) {
                        // line 71
                        echo "                  ";
                        if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "can", [($context["id"] ?? null), twig_constant("DELETE")], "method", false, false, false, 71)) {
                            // line 72
                  ...
                  ";
                        // line 79
                        if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "can", [($context["id"] ?? null), twig_constant("PURGE")], "method", false, false, false, 79)) {
                            // line 80
                            echo "                    ";
                  ...
                  ";
                        ...
                        if (( !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "maybeDeleted", [], "method", false, false, false, 108) || twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "useDeletedToLockIfDynamic", [], "method", false, false, false, 108))) {
                            // line 109
                            echo "                     ";
                            if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "can", [($context["id"] ?? null), twig_constant("PURGE")], "method", false, false, false, 109)) {
                                // line 110
                     ...
                     ";
                            ...
                            // line 117
                            echo "                  ";
                        } elseif (( !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isDeleted", [], "method", false, false, false, 117) && twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "can", [($context["id"] ?? null), twig_constant("DELETE")], "method", false, false, false, 117))) {
                            // line 118
            ...
            ";
                // line 127
                if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isField", ["date_mod"], "method", false, false, false, 127)) {
                    // line 128
         ...
         ";
            // line 132
            if ( !twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isNewID", [($context["id"] ?? null)], "method", false, false, false, 132)) {
                // line 133
    ...
    {
        return new Source("", "components/form/buttons.html.twig", "/var/www/html/glpi/templates/components/form/buttons.html.twig");
    }
}
